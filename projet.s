...
VoisinResolution:
    ...
    beqz $v0 VoisinR                 # si $v0 vaut 0 cela veut dire qu'il n'y en a pas donc on peut aller à gauche
    bnez $v0 FinVoisinRGauche        #sinon on ne peut pas
    VoisinR:
    sw $a1 0($sp)                   # on sauvegarde l'indice du voisin trouvé sur la pile
    FinVoisinRGauche:
    ...
    beqz $v0 VoisinR1                 # si $v0 vaut 0 cela veut dire qu'il n'y en a pas donc on peut aller à droite
    bnez $v0 FinVoisinRDroite        # sinon on ne peut pas
    VoisinR1:
    sw $a1 0($sp)                   # on sauvegarde l'indice du voisin trouvé sur la pile
    FinVoisinRDroite:
    ...
    beqz $v0 VoisinR2		    # si $v0 vaut 0 cela veut dire qu'il n'y en a pas donc on peut aller en haut
    bnez $v0 FinVoisinRHaut          # sinon on ne peut pas
    VoisinR2:
    sw $a1 0($sp)                   # on sauvegarde l'indice du voisin trouvé sur la pile
    FinVoisinRHaut:
    ...
    beqz $v0 VoisinR3                # Si $v0 vaut 0 cela veut dire qu'il n'y en a pas donc on peut aller en bas
    bnez $v0 FinVoisinRBas           # Sinon on ne peut pas
    VoisinR3:
    sw $a1 0($sp)                   # on sauvegarde l'indice du voisin trouvé sur la pile
    FinVoisinRBas:
